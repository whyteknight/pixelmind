...
import { brainServices, brainServicesIcons } from "../constants";
    ...
    <Section crosses id="how-to-use">
      <div className="container">
        <Heading
          ...
          text="Pixelmind unlocks the potential of AI-powered applications"
        />
        <div className="relative">
          <div className="relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
            <div className="absolute top-0 left-0 w-full h-full pointer-events-none md:w-3/5 xl:w-auto">
              <img
                className="w-full h-full object-cover md:object-right opacity-2"
                width={800}
                height={730}
                alt="Smartest AI"
                src={service1}
            ...
            <div className="relative z-1 max-w-[17rem] ml-auto">
              ...
              <p className="body-2 mb-[3rem] text-n-3">
                Pixelmind unlocks the potential of AI-powered applications
              </p>
              <ul className="body-2">
            ...
            <div className="p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem]">
              <div className="py-12 px-4 xl:px-8">
                ...
                <ul className="flex items-center justify-between">
                  {brainServicesIcons.map((item, index) => (
                    <li
                      key={index}
              ...
              <div className="relative h-[20rem] bg-n-8 rounded-xl overflow-hidden md:h-[25rem]">
                <img
                  ...
                  className={`w-full h-full object-cover
                    ${isPlaying} && pointer-events-none select-none`}
                  width={520}
                  height={400}
                  alt="robot"
                />
