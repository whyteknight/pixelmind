...
import { brainWhiteSymbol, gradient, play, pause, loading } from "../../assets";
  ...
  return (
    <div className="absolute top-8 right-8 w-[18rem] h-[6rem] py-6 px-8 bg-black rounded-t-xl rounded-bl-xl font-code text-base lg:top-16 lg:right-[8.75rem]">
      <TypewriterComponent
        options={{
          strings: [
            "Hey PixelMind, enhance this photo.",
            "PixelMind, apply your magic to this photo.",
            "Activate PixelMind mode to boost this photo.",
          ],
          autoStart: true,
          loop: true,
        }}
  ...
  return (
    <div className="absolute top-8 left-[3.125rem] w-full max-w-[14rem] pt-2.5 pr-2.5 pb-7 pl-5 bg-n-6 rounded-t-xl rounded-br-xl font-code text-base md:max-w-[17.5rem]">
      ...
      <div className="absolute left-5 -bottom-[1.125rem] flex items-center justify-center w-[2.25rem] h-[2.25rem] bg-color-1 rounded-[0.75rem]">
        <img src={brainWhiteSymbol} width={26} height={26} alt="brain" />
      </div>
